...
const securutiryCodePattern = {
  mask: "0000",
}
const securityCodeMasked = IMask(securityCode, securutiryCodePattern)
...
securityCodeMasked.on("accept", () => {
  uptadeSecutityCode(securityCodeMasked.value)
})

function uptadeSecutityCode(code){
